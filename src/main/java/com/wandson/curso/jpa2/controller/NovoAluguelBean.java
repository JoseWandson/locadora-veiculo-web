...
import com.wandson.curso.jpa2.modelo.ApoliceSeguro;
import com.wandson.curso.jpa2.modelo.Carro;
import com.wandson.curso.jpa2.service.CadastroAluguelService;
...
public class NovoAluguelBean implements Serializable {
	...
	private transient Aluguel aluguel;

	private transient List<Carro> carros;
